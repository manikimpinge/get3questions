...
if ( isCanvasSupported() ) {
	// canvas element
	var c = document.getElementById("g3q-chart");

	// add styles required only when canvas supported
	var circle = document.getElementById("g3q-circle");
	circle.className = circle.className + " canvas";
